import * as echarts1 from '../../ec-canvas/echarts.min';

var wxcharts = require('../../ec-canvas/wxcharts.js');
// import * as china from '../../ec-canvas/china'
...
// }, 0);
function initChart1(canvas, height, width){
  var color = ['#b7d6f3', '#86E3FC', '#40a9ed', '#3598c1', '#215096'];
  var chart = echarts1.init(canvas, null, {
    width: width,
    height: height
  });
...
Page({
  ...
  onLoad: function (options) {
    ...
    //chartId, optionType, yData, xData, title
    for(let i=0;i<typeArr.length;i++){
      ...
      if(type1=='type1'){
        optionType = 'column';
        yData = [100,300,400,600,200];
        xData = ['1点','2点','3点','4点','5点'];
        title = '线下各类交易统计';
      }else if(type1=='type2'){
        optionType = 'line';
        yData = [100, 300, 400, 600, 200];
        ...
        optionType = 'pie';
        yData = [100, 300, 400, 600, 200];
        xData = ['20岁', '30岁', '40岁', '50岁', '60岁'];
        title = '客户所占比例';
      }
      loadOption(type1, optionType, yData, xData, title);
    }
...
var chart =null;
 if(chartId=='type3'){
  chart= new wxcharts({
     animation: true,
     canvasId: chartId,
     color: ['#b7d6f3', '#86E3FC', '#40a9ed', '#3598c1', '#215096'],
     type: 'pie',
     series: [{
       name: '20岁',
       data: 15,
